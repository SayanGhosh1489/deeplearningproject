...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainingArtifcat:
        try:
            logging.info(
            ...
            optimizer: Optimizer = torch.optim.SGD(
                model.parameters(), **self.model_trainer_config.optimizer_parms
            )

            scheduler: _LRScheduler = StepLR(
                optimizer=optimizer, **self.model_trainer_config.momentum_parms
            )
            ...
            bentoml.pytorch.save_model(
                ...
                model=model,
                custom_objects={
                    self.model_trainer_config.train_tranform_key: train_transforms_obj
                },
            )

            model_trainer_artifact: ModelTrainingArtifcat = ModelTrainingArtifcat(
